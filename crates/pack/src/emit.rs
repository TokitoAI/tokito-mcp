...
/// followed by two digits, `x`, two digits, and an optional known suffix
/// (`_Pin`, `_Socket`, `_MountingPin`, `_Shielded`). Covers the `Conn_01xNN`
/// / `Conn_02xNN` families across `Connector`, `Connector_Generic`,
/// `Connector_Generic_MountingPin`, and `Connector_Generic_Shielded`.
fn is_generic_pin_header(name: &str) -> bool {
    ...
    matches!(
        &rest[5..],
        "" | "_Pin" | "_Socket" | "_MountingPin" | "_Shielded"
    )
}
